...
#########################################
faultdata='rogue-attack'
df = pd.read_csv('C:\\Users\\moham\\Downloads\\Dataset\\but-iec104-i\\rogue-device.csv',sep=';')
df = df[df['cot']==3]
...
dfSWTtest = df.query("2244.065119000 < RelativeTime <3866.136892000")
...
ocsvm = svm.OneClassSVM(kernel="rbf",nu=0.001,gamma=0.6)
