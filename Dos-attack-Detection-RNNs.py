...
all = ['TimeStamp', 'RelativeTime', 'srcIP', 'dstIP', 'srcPort', 'dstPort',
       ...
       'addr', 'ioa']
columns=['srcIP', 'dstIP', 'srcPort', 'dstPort','ipLen']
###########################################
...
print(ndf.head())
print(ndf.columns)
dfNormalTest = ndf.query("280004 > RelativeTime > 210000")
print("dfNormalTest shape : ",dfNormalTest.shape)
#print(dfNormal.isnull().sum())
dfNormalTrain = ndf.query("90000 < RelativeTime < 200004")
print("dfNormal shape : ",dfNormalTrain.shape)
#########################################
faultdata='dos-attack'
df = pd.read_csv('C:\\Users\\moham\\Downloads\\Dataset\\but-iec104-i\\dos-attack.csv',sep=';')
...
dfSWTtest = df.query("42508.969874 < RelativeTime < 48017.627383")
