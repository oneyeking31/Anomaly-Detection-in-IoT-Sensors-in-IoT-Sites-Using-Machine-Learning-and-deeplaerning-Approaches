...
all = ['TimeStamp', 'RelativeTime', 'srcIP', 'dstIP', 'srcPort', 'dstPort',
       ...
       'addr', 'ioa']
columns=['srcIP', 'dstIP', 'srcPort', 'dstPort','asduType','ipLen']
#########################################
...
print(ndf.columns)
dfNormalTest = ndf.query("RelativeTime > 210000")
print("dfNormalTest shape : ",dfNormalTest.shape)
#print(dfNormal.isnull().sum())
dfNormalTrain = ndf.query("0 < RelativeTime < 200004")
print("dfNormalTest shape : ",dfNormalTest.shape)
#print(dfNormal.isnull().sum())
...
dfSWTtest = df.query("56778 < RelativeTime < 58000")
print("dfSWTStest shape : ",dfSWTtest.shape)#dfSWTtest = df.query("42508.969874 < RelativeTime < 48017.627779")
...
ifo = IsolationForest(contamination=0.005)
